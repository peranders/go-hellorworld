...
func handler(w http.ResponseWriter, r *http.Request) {
	...
	if err := validateJWTFromComputeEngine(w, iapHeader); err != nil {
		log.Fatal(err)
	}
...
func validateJWTFromComputeEngine(w io.Writer, iapJWT string) error {
...
// 	aud := fmt.Sprintf("/projects/%s/global/backendServices/%s", projectNumber, backendServiceID)
	aud := "/projects/940733461091/global/backendServices/3463990049096674786"
